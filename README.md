...
| **Smithery** | `smithery mcp install g-digital/ead-factory` (from v1.0.7) — [[smithery.ai/server/g-digital/ead-factory](https://smithery.ai/servers/g-digital/ead-factory)]|
