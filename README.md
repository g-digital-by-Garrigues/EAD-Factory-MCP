...
| `MCP_API_BASE_URL_CHAT` | No | No | chat manager base URL (default: https://api.gcloudfactory.com/chat-bot-manager) |
| `MCP_API_BASE_URL_EVIDENCE` | No | No | evidence manager base URL (default: https://api.gcloudfactory.com/digital-trust) |
| `MCP_API_BASE_URL_NOTIFICATION` | No | No | notification manager base URL (default: https://api.gcloudfactory.com/notifications) |
| `MCP_API_BASE_URL_SIGNATURE` | No | No | signature manager base URL (default: https://api.gcloudfactory.com/signature-manager) |
| `MCP_AUTH_EMAIL` | No | No | Your EAD Factory account email (Flow 1). Configure exactly one of Flow 1, 2, or 3. |
| `MCP_AUTH_PASSWORD` | No | Yes | Your EAD Factory account password (Flow 1, email/password accounts) (See https://digitaltrust.gcloudfactory.com for credential acquisition.) |
...
| `MCP_OPENID_REFRESH_TOKEN` | No | Yes | OpenID Connect refresh token (Flow 2) (See https://digitaltrust.gcloudfactory.com for credential acquisition.) |
| `MCP_SVC_CLIENT_ID` | No | No | OAuth2 client_credentials client ID (Flow 3) |
| `MCP_SVC_CLIENT_SECRET` | No | Yes | OAuth2 client_credentials client secret (Flow 3) (See https://digitaltrust.gcloudfactory.com for credential acquisition.) |
